    ...
    return (
        <Main page='privacy'>
            ...
            <section className='privacy__intro'>
                <p>
                    Thank you for choosing to be part of our community at Ibuki Training (“Company”,
                ...
                <p>
                    When you visit our website <a href='/'>https://www.ibukitraining.com</a>, and
                    use our services, you trust us with your personal information. We take your
                    privacy very seriously. In this privacy policy, we seek to explain to you in the
                ...
                <p>
                    ...
                    (such as <a href='/'>https://www.ibukitraining.com</a>), and/or any related
            ...
            <section className='privacy__content'>
                ...
                <ol>
                    ...
                    <li>
                        <a href='#two'> WILL YOUR INFORMATION BE SHARED WITH ANYONE?</a>
                    </li>
                    <li>
                        <a href='#three'> DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</a>
                    </li>
                    <li>
                        <a href='#four'> HOW LONG DO WE KEEP YOUR INFORMATION?</a>
                    </li>
                    <li>
                        <a href='#five'> HOW DO WE KEEP YOUR INFORMATION SAFE?</a>
                    </li>
                    <li>
                        <a href='#six'> DO WE COLLECT INFORMATION FROM MINORS?</a>
                    </li>
                    <li>
                        <a href='#seven'> WHAT ARE YOUR PRIVACY RIGHTS?</a>
                    </li>
                    <li>
                        <a href='#eight'> DATA BREACH</a>
                    </li>
                    <li>
                        <a href='#nine'> CONTROLS FOR DO-NOT-TRACK FEATURES</a>
                    </li>
                    <li>
                        <a href='#ten'> DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</a>
                    </li>
                    <li>
                        <a href='#eleven'> DO WE MAKE UPDATES TO THIS POLICY?</a>
                    </li>
                    <li>
                        <a href='#twelve'> HOW CAN YOU CONTACT US ABOUT THIS POLICY?</a>
                    </li>
                </ol>
            </section>

            <section className='privacy__content' id='one'>
                ...
                <p>
                    <b>Publicly Available Personal Information.</b> We collect first name, maiden
                    name, last name, and nickname; phone numbers; email addresses; and other similar
                    data.
                </p>
                ...
                <p>
                    <i>
                        <b>In Short:</b> Some information — such as IP address and/or browser and
                ...
                <p>
                    <b>Online Identifiers.</b> We collect cookie from reCAPTCHA; and other similar
                    data.
                </p>
            </section>
            <section className='privacy__content' id='two'>
                <h3>2. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</h3>

                <p>
                    <i>
                        <b>In Short:</b> We only share information with your consent, to comply with
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            serve ads when you visit the Services. These companies may use
            ...
            <section class='privacy__content' id='three'>
            ...
            <section class='privacy__content' id='four'>
            ...
            <section class='privacy__content' id='five'>
            ...
            <section class='privacy__content' id='six'>
            ...
            <section class='privacy__content' id='seven'>
                <h3>7. WHAT ARE YOUR PRIVACY RIGHTS?</h3>

                <p>
                    <i>
                        <b>In Short:</b> In some regions, such as the European Economic Area, you
            ...
            <section class='privacy__content' id='eight'>
                <h3>8. DATA BREACH</h3>

                <p>
                    A privacy breach occurs when there is unauthorized access to or collection, use,
                    disclosure or disposal of personal information. You will be notified about data
                    breaches when Ibuki Training believes you are likely to be at risk or serious
                    harm. For example, a data breach may be likely to result in serious financial
                    harm or harm to your mental or physical well-being. In the event that Ibuki
                    Training becomes aware of a security breach which has resulted or may result in
                    unauthorized access, use or disclosure of personal information Ibuki Training
                    will promptly investigate the matter and notify the applicable Supervisory
                    Authority not later than 72 hours after having become aware of it, unless the
                    personal data breach is unlikely to result in a risk to the rights and freedoms
                    of natural persons.
                </p>
            </section>

            <section class='privacy__content' id='nine'>
            ...
            <section class='privacy__content' id='ten'>
            ...
            <section class='privacy__content' id='eleven'>
            ...
            <section class='privacy__content' id='twelve'>
            ...
            <section class='privacy__content'>
                ...
                <p>
                    Based on the laws of some countries, you may have the right to request access to
                    the personal information we collect from you, change that information, or delete
                    it in some circumstances. To request to review, update, or delete your personal
                    information, please submit a request form by clicking{' '}
                    <a href='https://app.termly.io/notify/7bf0c4e2-68fd-41ab-9c74-d3a1ac3776b1'>
                        here
                    </a>
